...
void               ClapTrap::setMP(int mp) { _energyPoints = mp; }
void               ClapTrap::setAD(int ad) { _attackDamage = ad; }

void ClapTrap::attack(std::string const &target) const {
  std::cout << "\n[ Attack ] ClapTrap " << _name << " attacks " << target
...
void ClapTrap::takeDamage(unsigned int amount) {
  ...
  _hitPoints -= amount;
  std::cout << "\n[ Take Damage ] ClapTrap " << _name << " got a " << amount
            << " damages " << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount) {
  unsigned int tmp = _hitPoints;
  _hitPoints += amount;
  std::cout << "\n[ Repaired ] ClapTrap " << _name << " recovered " << amount
            << " HP" << std::endl;
